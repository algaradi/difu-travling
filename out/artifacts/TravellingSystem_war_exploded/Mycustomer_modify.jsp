...
<form action="customerServlet"  method="post" style=" height:100%; width: 100%; text-align: center; " >
    <input type="hidden" name="action" value="editMe">
    <table align="center" id="modify_table_hotel" class="modify_table">
        ...
        <tr>
            ...
            <td><input class="textarea" id="custName" name="custName" value="${sessionScope.cust.custName}" required readonly></td>
        </tr>
        <tr>
            <td>密码：</td>
            <%--  required 属性规定必需在提交表单之前填写输入字段  --%>
            <td><input class="textarea" id="password" name="password" value="${sessionScope.cust.password}" required><font
                    color="red">*</font></td>
        </tr>
        <tr>
            <td>用户类型：</td>
            <td><input class="textarea" id="type" name="sex" value="${sessionScope.cust.type}"></td>
        </tr>
        <tr>
            <td>联系方式：</td>
            <td><input class="textarea" id="custPhone" name="classid" value="${sessionScope.cust.custPhone}"></td>
        </tr>
    </table>
    <table align="center">
