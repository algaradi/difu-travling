    ...
    <input type="hidden" name="action" value="edit">
        <table align="center" id="modify_table_hotel" class="modify_table">
            ...
            <tr>
                ...
                <td><input class="textarea" id="custName" name="hotelName" value="${param.hotelName}" required readonly></td>
            </tr>
            <tr>
                <td>价格/24小时：</td>
                <%--  required 属性规定必需在提交表单之前填写输入字段  --%>
                <td><input class="textarea" id="password" name="price" value="${param.price}" required><font
                        color="red">*</font></td>
            </tr>
            <tr>
                <td>房间数量：</td>
                <td><input class="textarea" id="type" name="numRooms" value="${param.numRooms}"></td>
            </tr>
            <tr>
                <td>所在的城市：</td>
                <td><input class="textarea"  name="cityName" value="${param.cityName}"></td>
            </tr>
            <tr>
                <td>详细地址：</td>
                <td><input class="textarea"  name="address" value="${param.address}"></td>
            </tr>
        </table>
        <table align="center">
