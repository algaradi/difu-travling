...
<form action="customerServlet"  method="post" style=" height:100%; width: 100%; text-align: center; " >
    ...
    <table align="center" id="modify_table_hotel" class="modify_table">
        ...
        <tr>
            ...
            <td><input class="textarea" id="custName" name="custName" value="${param.custName}" required readonly></td>
        </tr>
        <tr>
            <td>密码：</td>
            <%--  required 属性规定必需在提交表单之前填写输入字段  --%>
            <td><input class="textarea" id="password" name="password" value="${param.password}" required><font
                    color="red">*</font></td>
        </tr>
        <tr>
            <td>用户类型：</td>
            <td><input class="textarea" id="type" name="type" value="${param.type}"></td>
        </tr>
        <tr>
            <td>联系方式：</td>
            <td><input class="textarea" id="custPhone" name="custPhone" value="${param.custPhone}"></td>
        </tr>
    </table>
    <table align="center">
